...
addApp({"id":"pixel", "label": "Pixels", "info": "Eine Leinwand, viele Künstler. Jetzt mit kostenlosen Farben!"});
...
addApp({"id":"debug", "label": "DEBUG", "info": "Debugging, zeigt infos an und so", "level": 50});
